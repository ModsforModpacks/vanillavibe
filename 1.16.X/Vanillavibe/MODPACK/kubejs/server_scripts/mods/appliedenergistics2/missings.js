...
events.listen("recipes", function(event) {
  ...
  // Smooth slab
  event.remove({
    output: "appliedenergistics2:smooth_sky_stone_slab"
  });
  ...
  // Small Brick Slab
  event.remove({
    output: "appliedenergistics2:sky_stone_small_brick_slab"
  });
  ...
  // Brick slab
  event.remove({
    output: "appliedenergistics2:sky_stone_brick_slab"
  });
  ...
  // Fluix Slab
  event.remove({
    output: "appliedenergistics2:fluix_slab"
  });
  ...
  // Stone Slab
  event.remove({
    output: "appliedenergistics2:sky_stone_slab"
  });
  ...
  // Quartz Slab
  event.remove({
    output: "appliedenergistics2:quartz_slab"
  });
  ...
  // Quartz Pillar Slab
  event.remove({
    output: "appliedenergistics2:quartz_pillar_slab"
  });
  ...
  event.remove({
    output: "appliedenergistics2:chiseled_quartz_slab"
  });
  ...
  // Smooth Stairs
  event.remove({
    output: "appliedenergistics2:smooth_sky_stone_stairs"
  });
  ...
  // Small Brick Stairs
  event.remove({
    output: "appliedenergistics2:sky_stone_small_brick_stairs"
  });
  ...
  // Brick Stairs
  event.remove({
    output: "appliedenergistics2:sky_stone_brick_stairs"
  });
  ...
  // Fluix Stairs
  event.remove({
    output: "appliedenergistics2:fluix_stairs"
  });
  ...
  // Stone Stairs
  event.remove({
    output: "appliedenergistics2:sky_stone_stairs"
  });
  ...
  // Quartz Stairs
  event.remove({
    output: "appliedenergistics2:quartz_stairs"
  });
  ...
  event.remove({
    output: "appliedenergistics2:quartz_pillar_stairs"
  });
  ...
  event.remove({
    output: "appliedenergistics2:chiseled_quartz_stairs"
  });
