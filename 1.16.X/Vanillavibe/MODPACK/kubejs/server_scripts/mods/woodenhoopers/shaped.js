...
events.listen("recipes", function(event) {
  ...
  // Oak Hopper
  event.remove({
    output: "woodenhoppers:oak_hopper"
  });
  ...
  // Spruce Hopper
  event.remove({
    output: "woodenhoppers:spruce_hopper"
  });
  ...
  // Birch Hopper
  event.remove({
    output: "woodenhoppers:birch_hopper"
  });
  ...
  // Jungle Hopper
  event.remove({
    output: "woodenhoppers:jungle_hopper"
  });
  ...
  // Acacia Hopper
  event.remove({
    output: "woodenhoppers:acacia_hopper"
  });
  ...
  // Dark Oak Hopper
  event.remove({
    output: "woodenhoppers:dark_oak_hopper"
  });
  ...
  // Crimson Hopper
  event.remove({
    output: "woodenhoppers:crimson_hopper"
  });
  ...
  // Warped Hopper
  event.remove({
    output: "woodenhoppers:warped_hopper"
  });
