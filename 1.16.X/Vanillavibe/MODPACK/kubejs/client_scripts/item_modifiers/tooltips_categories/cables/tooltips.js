...
//╚════════════════════════════════════════╝
  tooltip.addAdvanced('techreborn:copper_cable', (item, advanced, text) => {
    text.add(1, Text.of('Transfer rate: 128 E/t').color('#FFAA00'))
